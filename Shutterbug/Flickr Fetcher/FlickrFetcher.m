...
{
    // &user_id=124877801@N03
    return [self URLForQuery:[NSString stringWithFormat:@"https://api.flickr.com/services/rest/?method=flickr.photos.search&has_geo=&license=1,2,4,7&extras=original_format,description,geo,date_upload,owner_name"]];
}
